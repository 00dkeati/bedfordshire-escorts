        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="card-elegant mb-12">
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <p>
                From the bustling streets of Milton Keynes to the picturesque villages of the Chilterns, 
                we serve clients throughout the county with the same commitment to excellence and discretion.
              </p>
            </div>
          </div>
