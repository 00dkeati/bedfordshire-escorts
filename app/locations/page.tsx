...
export const metadata: Metadata = {
  title: "Locations | Bedfordshire Escorts Agency",
  description: "Find escorts across all of Bedfordshire. Bedford, Luton, Dunstable, Leighton Buzzard, Biggleswade and 10+ more towns covered.",
};

const towns = [
  { slug: "bedford", name: "Bedford", description: "Bedfordshire's historic county town with premium escorts" },
  { slug: "luton", name: "Luton", description: "Diverse companions in Bedfordshire's largest town" },
  ...
  { slug: "biggleswade", name: "Biggleswade", description: "Discreet services in Central Bedfordshire" },
  ...
  { slug: "houghton-regis", name: "Houghton Regis", description: "Premium escorts in South Bedfordshire" },
      ...
      <section className="py-24 bg-gradient-to-b from-black via-zinc-900 to-zinc-950">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300">
            Elite escorts available across all of Bedfordshire
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="card-elegant text-center">
            ...
            <p className="text-gray-400 mb-6">
              ...
              home, hotel, or private venue anywhere in Bedfordshire. If your area isn&apos;t 
            ...
            <div className="mt-8">
              <div className="card-elegant bg-zinc-800/50">
                ...
                <p className="text-gray-400 text-sm">
                  ...
                  anywhere in Bedfordshire. Maximum convenience, complete discretion. 
      ...
      <section className="py-16 section-dark">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8">
            ...
            escort for you, wherever you are in Bedfordshire.
          </p>
          <a 
